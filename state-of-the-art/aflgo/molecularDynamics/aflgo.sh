...
echo $'molecularDynamics_aflgo.cc:44\nmolecularDynamics_aflgo.cc:47\nmolecularDynamics_aflgo.cc:59\nmolecularDynamics_aflgo.cc:62\nmolecularDynamics_aflgo.cc:72\nmolecularDynamics_aflgo.cc:75' > $TMP_DIR/BBtargets.txt
