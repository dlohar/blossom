...
echo $'reactorSimulation_aflgo.cc:105\nreactorSimulation_aflgo.cc:118\nreactorSimulation_aflgo.cc:136' > $TMP_DIR/BBtargets.txt
...
cd build/; mkdir in
# ------------ Input to fuzz here ----------------------------------------
IN1=`./../../../getInput/get_rand_float.sh 1.0 5.0`
IN2=`./../../../getInput/get_rand_int.sh 10 50`
IN3=`./../../../getInput/get_rand_int.sh 2 5`
IN4=`./../../../getInput/get_rand_int.sh 100 100000000`
