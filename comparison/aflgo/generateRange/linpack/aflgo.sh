...
echo $'linpack_aflgo.c:29\nlinpack_aflgo.c:46' > $TMP_DIR/BBtargets.txt
...
# 3
# 1325" > in/in
IN1=`./../../../getInput/get_rand_float.sh 0.0 0.9`
IN2=`./../../../getInput/get_rand_int.sh 0 10`
IN3=`./../../../getInput/get_rand_int.sh 0 10`
IN4=`./../../../getInput/get_rand_int.sh 0 10`
IN5=`./../../../getInput/get_rand_int.sh 1000 3000`
