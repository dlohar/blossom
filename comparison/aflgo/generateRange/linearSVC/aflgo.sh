#! /bin/bash
# AFLGO execution script for linear_SVC_aflgo.c benchmark
...
echo $'linearSVC_aflgo.c:13' > $TMP_DIR/BBtargets.txt
...
cd build/; mkdir in
# ------------ Input to fuzz here ----------------------------------------
IN1=`./../../../getInput/get_rand_float.sh 4.0 8.0`
IN2=`./../../../getInput/get_rand_float.sh 2.0 4.5`
IN3=`./../../../getInput/get_rand_float.sh 1.0 7.0`
IN4=`./../../../getInput/get_rand_float.sh 0.1 2.5`
echo "$IN1 $IN2 $IN3 $IN4" > in/in
touch kernel_range.dat
# ------------ Name of the executable ------------------------------------
