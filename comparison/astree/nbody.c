...
void computeAccelerations(double masses[], vector * positions, vector * accelerations){
  ...
  for(i=0;i<bodies;i++){
    ...
    for(j=0;j<bodies;j++){
      if(i!=j){
        __ASTREE_log_vars((positions[i]; inter));
        __ASTREE_log_vars((positions[j]; inter));
        __ASTREE_log_vars((accelerations[i]; inter));
...
void simulate(double masses[], vector *positions, vector *velocities, vector *accelerations){
  ...
  __ASTREE_log_vars((velocities[0].x; inter));
  __ASTREE_log_vars((velocities[1].x; inter));
  __ASTREE_log_vars((velocities[2].x; inter));
  __ASTREE_log_vars((velocities[0].y; inter));
  __ASTREE_log_vars((velocities[1].y; inter));
  __ASTREE_log_vars((velocities[2].y; inter));
  __ASTREE_log_vars((velocities[0].z; inter));
  __ASTREE_log_vars((velocities[1].z; inter));
  __ASTREE_log_vars((velocities[2].z; inter));

  __ASTREE_log_vars((accelerations[0].x; inter));
  __ASTREE_log_vars((accelerations[1].x; inter));
  __ASTREE_log_vars((accelerations[2].x; inter));
  __ASTREE_log_vars((accelerations[0].y; inter));
  __ASTREE_log_vars((accelerations[1].y; inter));
  __ASTREE_log_vars((accelerations[2].y; inter));
  __ASTREE_log_vars((accelerations[0].z; inter));
  __ASTREE_log_vars((accelerations[1].z; inter));
  __ASTREE_log_vars((accelerations[2].z; inter));
