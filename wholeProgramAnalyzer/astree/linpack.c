...
*/
  if ( incx != 1 || incy != 1 )
  {
    ...
    __ASTREE_log_vars((dx[0]; inter));
    __ASTREE_log_vars((dx[1]; inter));
    __ASTREE_log_vars((dx[2]; inter));
    __ASTREE_log_vars((dx[3]; inter));

    __ASTREE_log_vars((dy[0]; inter));
    __ASTREE_log_vars((dy[1]; inter));
    __ASTREE_log_vars((dy[2]; inter));
    __ASTREE_log_vars((dy[3]; inter));
